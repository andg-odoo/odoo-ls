...
class BikesBike(models.Model):
    ...
    def _compute_bike_weight(self):
        ...
        self.env.ref('base.module_base') # Ok, generated by the registry
        self.env.ref('base.field_res_partner__name') # Ok, generated by the registry
        self.env.ref('base.selection__res_partner__type__contact') # Ok, generated by the registry
