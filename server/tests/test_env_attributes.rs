...
/// `self.env.user`/`company`/`companies`/`lang` resolve to their real types, chains included.
#[test]
...
/// A property reached through a variable resolves just like the direct chain.
#[test]
