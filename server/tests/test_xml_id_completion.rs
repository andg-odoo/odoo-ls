...
/// xml_id string literals complete from the xml_ids of the current module and of its dependencies,
/// filtered to res.groups records where the position implies it (`groups=`, `has_group`).
#[test]
