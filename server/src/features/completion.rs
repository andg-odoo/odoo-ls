...
/// Expected type of the first argument of the functions taking an xml_id, None for any other function
    ...
    for expected_type in expected_type.iter() {
        match expected_type {
            ...
            ExpectedType::XML_ID(model_filter) => {
                ...
                // groups="a,b" is a comma-separated list: only complete the segment under the cursor.
                // groups entries may be negated with a leading '!' (see odoo.tools.set_expression)
